INSERT INTO users (username, email, password, role, first_name, last_name, created_at, profile_image_url, enabled)
VALUES
    ('tutor1', 'tutor1@example.com', '$2a$12$LfE80ftlELiMwgGVnZFYTObPuMRACH/zjUETR7S6Uuk8EJf7jS3Bi', 'TUTOR', 'John', 'Doe', CURRENT_TIMESTAMP, 'https://example.com/tutor1.jpg', true),
    ('tutor2', 'tutor2@example.com', '$2a$12$LfE80ftlELiMwgGVnZFYTObPuMRACH/zjUETR7S6Uuk8EJf7jS3Bi', 'TUTOR', 'Jane', 'Smith', CURRENT_TIMESTAMP, 'https://example.com/tutor2.jpg', true);
INSERT INTO tutors (username, description, rating, experience_years)
VALUES
    ('tutor1', 'Experienced tutor with 10 years of teaching programming', 4.8, 10),
    ('tutor2', 'Professional tutor specializing in algorithms and data structures', 4.9, 8);
